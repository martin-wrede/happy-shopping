      ...
      <div className="meindiv" >
          <form onSubmit={handleSubmit}>
            ...
            <div className="meindiv3" id="id3"  style={showDiv}  >  
                <input type="text" defaultValue="Happy Shopping" className="input" onChange={changeTitle} /> 
            </div>
            <br />
          
            {/*
            <div className="meindiv4" id="id4"  style={showDiv}  >  
                <input type="text" defaultValue="" className="input" onChange={changeName} />  
            </div>
            <div className="meindiv5" id="id5"   style={showDiv}  >        
                <input type="text" defaultValue="" className="input"  onChange={changeText} /> 
            </div>
            */}
